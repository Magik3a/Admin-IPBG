...
using Administration = AdminIPBG.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "icon-screen-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: AdminIPBG.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
