...
namespace AdminIPBG.Rows.Entities
{
    ...
    [ReadPermission("Rows:NoteRow:Read")]
    [InsertPermission("Rows:NoteRow:Insert")]
    [UpdatePermission("Rows:NoteRow:Update")]
    [DeletePermission("Rows:NoteRow:Delete")]
    [LookupScript("Rows.Notes")]
